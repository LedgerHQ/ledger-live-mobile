...
function DeviceNanoXAction({ action, screen, error, width = 272, wired }: Props) {
    ...
    <Svg width={newWidth} height={(newWidth * 87) / 486} viewBox="0 0 486 87">
      <G fill="none" fillRule="evenodd">
        <G transform="translate(100 45)">
          ...
          />
          <Circle cx="135" cy="21" r="10.5" stroke={colors.darkBlue} strokeLinejoin="square" />
          <Circle cx="135" cy="21" r="11.5" stroke={colors.fog} />
          <G>
            <Circle cx="25" cy="21" r="10.5" stroke={colors.darkBlue} strokeLinejoin="square" />
