...
class DebugSVG extends Component<{}> {
  ...
  icons = (): Array<Object> =>
    [
      ...
      {
        name: "DeviceNanoMedium",
        bitmap: 0,
        square: 0,
        component: DeviceNanoMedium,
      },
      ...
      {
        name: "DeviceNanoAction",
        bitmap: 0,
        square: 0,
        component: DeviceNanoAction,
      },
      ...
      { name: "Paybis", bitmap: 0, square: 0, component: Paybis },
      { name: "Changelly", bitmap: 0, square: 0, component: Changelly },
      { name: "Coinmama", bitmap: 0, square: 0, component: Coinmama },
      { name: "Shapeshift", bitmap: 0, square: 0, component: Shapeshift },
      { name: "Coinhouse", bitmap: 0, square: 0, component: Coinhouse },
      { name: "Changenow", bitmap: 1, square: 0, component: Changenow },
      { name: "Genesis", bitmap: 0, square: 0, component: Genesis },
      { name: "Thorswap", bitmap: 1, square: 0, component: Thorswap },
      { name: "Kyber", bitmap: 0, square: 0, component: Kyber },
      { name: "Simplex", bitmap: 0, square: 0, component: Simplex },
      { name: "Kyberswap", bitmap: 1, square: 0, component: Kyberswap },
      { name: "Luno", bitmap: 0, square: 0, component: Luno },
      {
      ...
      { name: "PhoneBle", bitmap: 0, square: 0, component: PhoneBle },
      {
        name: "FallbackCamera",
        bitmap: 0,
        square: 0,
