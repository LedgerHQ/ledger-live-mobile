...
const GraphCardContainer = ({
  ...
  const showDistribution = portfolio.balanceHistory[portfolio.balanceHistory.length - 1].value > 0;
  return (
    <View>
      <Header
      ...
      {showGreeting && (
        <GraphCard counterValueCurrency={counterValueCurrency} portfolio={portfolio} />
      )}
    </View>
  );
};
