...
import bridge from "@segment/analytics-react-native/build/esm/bridge";
...
import SummaryFromSection from "../SendFunds/SummaryFromSection";
import SummaryToSection from "../SendFunds/SummaryToSection";
import SummaryAmountSection from "../SendFunds/SummaryAmountSection";
import SummaryNft from "../SendFunds/SummaryNft";
import SummaryTotalSection from "../SendFunds/SummaryTotalSection";
import SectionSeparator from "../../components/SectionSeparator";
import AlertTriangle from "../../icons/AlertTriangle";
import ConfirmationModal from "../../components/ConfirmationModal";
import NavigationScrollView from "../../components/NavigationScrollView";
import Info from "../../icons/Info";
import TooMuchUTXOBottomModal from "../SendFunds/TooMuchUTXOBottomModal";
...
const defaultParams = {
  currentNavigation: ScreenName.PaySummary,
  nextNavigation: ScreenName.PaySelectDevice,
};
...
function SendSummary({ navigation, route: initialRoute }: Props) {
  ...
  const {
    ...
    const transaction = bridge.updateTransaction(tx, {
      amount: new BigNumber(paD.amount),
    ...
    >
      ...
      <NavigationScrollView style={styles.body}>
        ...
        <Flex>
          ...
          <Text variant="small">{parsedData.message}</Text>
        </Flex>
        <SendRowsCustom
