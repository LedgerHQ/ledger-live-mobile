...
export default function TabNanoX({ size = 16, width, height, color, style }: Props) {
  return (
    <Svg width={width || size} height={height || size} viewBox="0 0 16 16" style={style}>
      <G id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <G id="nano-x" transform="translate(5.000000, 0.000000)" fill={color} fillRule="nonzero">
          <G id="a-link">
            <Path
